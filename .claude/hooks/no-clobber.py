# Vendored from alegauss/polyweave .claude/hooks/no-clobber.py at c45f7b3d3083f5747bb97a3cdfe309a605c4d058.
# Everything below this header is that file byte for byte; diff it against the source to
# see drift, and change it there first. Adopted here as CCF6.
